...
import ArtistsSwiper from "@/components/ArtistsSwiper/ArtistsSwiper";
    ...
    return (
        <>
            ...
            <section className="d-flex flex-column flex-lg-row">
                <section className="bgIMG2 col-lg-8 col-12"></section>
                <LandingForm />
            </section>
                    ...
                    <div className="py-5" style={{ backgroundColor: 'rgb(24, 24, 24)' }}>
                        <div className="container">
                            <div className="row d-flex flex-column-reverse flex-xl-row flex-lg-row">
                                ...
                                <div className="col-12 col-lg-6 col-md-12 px-5">
                    ...
                    <div className="py-5" style={{ backgroundColor: 'rgb(24, 24, 24)' }}>
                        <div className="container">
                            ...
                            <div className="row d-flex flex-column flex-xl-row flex-lg-row px-lg-2">
                                <div className="col-12 col-lg-4 col-xl-4 col-md-12 px-5 px-lg-2">
                                    <p className="fs-4 mb-0 text-white" style={{ fontSize: '1.3rem' }}>
                                        Building a Strong Network
                                    </p>
                                    <p className="lh-sm" style={{ fontSize: '1.3rem', color: 'rgb(172, 172, 172)' }}>
