...
export const metadata = {
    title: "Melo | Terms and Conditions",
    description: "Please see our Terms and Conditions below.",
    openGraph: {
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-12 col-lg-10 text-justify">
                            ...
                            <p className="display-7"><strong>OVERVIEW</strong></p>
                            <p className="display-7">This website is operated by <strong>Melo</strong>.
                                Throughout the site, the terms &ldquo;we&rdquo;,
                                &ldquo;us&rdquo; and &ldquo;our&rdquo; refer to<strong> Melo</strong>. <strong>Melo</strong> offers
                                ...
                                here.&nbsp;</p>
                            <p className="  display-7">By visiting our site and/ or purchasing something from us,
                                you engage in our &ldquo;Service&rdquo;
                            ...
                            <p className="  display-7">Please read these Terms of Service carefully before
                            ...
                            <p className="  display-7">Any new features or tools which are added to the current
                                store shall also be subject to the Terms of
                            ...
                            <p className="  display-7"><strong>SECTION 1 - ONLINE STORE TERMS</strong></p>
                            <p className="  display-7">By agreeing to these Terms of Service, you represent that
                                you are at least the age of majority in
                                ...
                                site.</p>
                            <p className="  display-7">You may not use our products for any illegal or
                            ...
                            <p className="  display-7">You must not transmit any worms or viruses or any code of
                                a destructive nature.</p>
                            <p className="  display-7">A breach or violation of any of the Terms will result in
                                an immediate termination of your
                                Services.<br /> </p>
                            <p className="  display-7"><strong>SECTION 2 - GENERAL CONDITIONS</strong></p>
                            <p className="  display-7">We reserve the right to refuse service to anyone for any
                                reason at any time.</p>
                            <p className="  display-7">You understand that your content (not including credit
                                card information), may be transferred
                            ...
                            <p className="  display-7">You agree not to reproduce, duplicate, copy, sell, resell
                                or exploit any portion of the Service, use
                            ...
                            <p className="  display-7">The headings used in this agreement are included for
                                convenience only and will not limit or otherwise
                                affect these Terms.<br /> </p>
                            <p className="  display-7"><strong>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS
                                OF INFORMATION</strong><br /> </p>
                            <p className="  display-7">We are not responsible if information made available on
                                this site is not accurate, complete or
                                ...
                                own risk.&nbsp;</p>
                            <p className="  display-7">This site may contain certain historical information.
                                ...
                                is your responsibility to monitor changes to our site.<br /> </p>
                            <p className="  display-7"><strong>SECTION 4 - MODIFICATIONS TO THE SERVICE AND
                                PRICES</strong></p>
                            <p className="  display-7">Prices for our products are subject to change without
                                notice.</p>
                            <p className="  display-7">We reserve the right at any time to modify or discontinue
                                the Service (or any part or content
                                thereof) without notice at any time.</p>
                            <p className="  display-7">We shall not be liable to you or to any third-party for
                                any modification, price change, suspension or
                                discontinuance of the Service.&nbsp;</p>
                            <p className="  display-7"><strong>SECTION 5 - PRODUCTS OR SERVICES</strong></p>
                            <p className="  display-7">Certain products or services may be available exclusively
                                online through the website. These products
                                or services may have limited quantities and are subject to return or exchange only according to our
                                Return Policy.&nbsp;</p>
                            <p className="  display-7">We have made every effort to display as accurately as
                                possible the colours and images of our products
                                that appear at the store. We cannot guarantee that your computer monitor&apos;s display of any colour
                                will be accurate.</p>
                            <p className="  display-7">We reserve the right, but are not obligated, to limit the
                                sales of our products or Services to any
                            ...
                            <p className="  display-7">We do not warrant that the quality of any products,
                                ...
                                corrected.</p>
                            <p className="  display-7"><strong>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT
                                INFORMATION</strong></p>
                            <p className="  display-7">We reserve the right to refuse any order you place with
                                us. We may, in our sole discretion, limit or
                            ...
                            <p className="  display-7">You agree to provide current, complete and accurate
                            ...
                            <p className="  display-7">For more detail, please review our Returns Policy.</p>
                            <p className="  display-7"><strong>SECTION 7 - OPTIONAL TOOLS</strong></p>
                            <p className="  display-7">We may provide you with access to third-party tools over
                                which we neither monitor nor have any
                                control nor input.</p>
                            <p className="  display-7">You acknowledge and agree that we provide access to such
                                tools &rdquo;as is&rdquo; and &ldquo;as
                                ...
                                third-party tools.</p>
                            <p className="  display-7">Any use by you of optional tools offered through the site
                            ...
                            <p className="  display-7">We may also, in the future, offer new services and/or
                                features through the website (including, the
                                release of new tools and resources). Such new features and/or services shall also be subject to
                                these Terms of Service.</p>
                            <p className="  display-7"><strong>SECTION 8 - THIRD-PARTY LINKS</strong></p>
                            <p className="  display-7">Certain content, products and services available via our
                                Service may include materials from
                                third-parties.</p>
                            <p className="  display-7">Third-party links on this site may direct you to
                            ...
                            <p className="  display-7">We are not liable for any harm or damages related to the
                                purchase or use of goods, services,
                            ...
                            <p className="  display-7"><strong>SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER
                                SUBMISSIONS</strong></p>
                            <p className="  display-7">If, at our request, you send certain specific submissions
                                (for example contest entries) or without a
                                ...
                                comments.&nbsp;</p>
                            <p className="  display-7">We may, but have no obligation to, monitor, edit or remove
                                content that we determine in our sole
                                ...
                                Service.&nbsp;</p>
                            <p className="  display-7">You agree that your comments will not violate any right of
                            ...
                            <p className="  display-7"><strong>SECTION 10 - PERSONAL INFORMATION</strong></p>
                            <p className="  display-7">Your submission of personal information through the store
                                is governed by our Privacy Policy.&nbsp;
                            </p>
                            <p className="  display-7"><strong>SECTION 11 - ERRORS, INACCURACIES AND
                                OMISSIONS</strong></p>
                            <p className="  display-7">Occasionally there may be information on our site or in
                                the Service that contains typographical
                            ...
                            <p className="  display-7">We undertake no obligation to update, amend or clarify
                            ...
                            <p className="  display-7"><strong>SECTION 12 - PROHIBITED USES</strong></p>
                            <p className="  display-7">In addition to other prohibitions as set forth in the
                                Terms of Service, you are prohibited from using
                            ...
                            <p className="  display-7"><strong>SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION
                                OF LIABILITY</strong></p>
                            <p className="  display-7">We do not guarantee, represent or warrant that your use of
                                our service will be uninterrupted, timely,
                                secure or error-free.</p>
                            <p className="  display-7">We do not warrant that the results that may be obtained
                                from the use of the service will be accurate
                                or reliable.&nbsp;</p>
                            <p className="  display-7">You agree that from time to time we may remove the service
                                for indefinite periods of time or cancel
                                the service at any time, without notice to you.</p>
                            <p className="  display-7">You expressly agree that your use of, or inability to use,
                                the service is at your sole risk. The
                            ...
                            <p className="  display-7">In no case shall<strong> Melo</strong>, our directors,
                            ...
                            <p className="  display-7"><strong>SECTION 14 - INDEMNIFICATION</strong></p>
                            <p className="  display-7">You agree to indemnify, defend and hold harmless
                                <strong>Melo </strong>and our parent, subsidiaries,
                            ...
                            <p className="  display-7"><strong>SECTION 15 - SEVERABILITY</strong></p>
                            <p className="  display-7">In the event that any provision of these Terms of Service
                                ...
                                provisions.</p>
                            <p className="  display-7"><strong>SECTION 16 - TERMINATION</strong></p>
                            <p className="  display-7">The obligations and liabilities of the parties incurred
                                prior to the termination date shall survive
                                the termination of this agreement for all purposes.</p>
                            <p className="  display-7">These Terms of Service are effective unless and until
                                terminated by either you or us. You may
                            ...
                            <p className="  display-7">If in our sole judgment you fail, or we suspect that you
                                have failed, to comply with any term or
                            ...
                            <p className="  display-7"><strong>SECTION 17 - ENTIRE AGREEMENT</strong></p>
                            <p className="  display-7">The failure of us to exercise or enforce any right or
                                provision of these Terms of Service shall not
                                constitute a waiver of such right or provision.&nbsp;</p>
                            <p className="  display-7">These Terms of Service and any policies or operating rules
                                posted by us on this site or in respect to
                            ...
                            <p className="  display-7">Any ambiguities in the interpretation of these Terms of
                                Service shall not be construed against the
                                drafting party.</p>
                            <p className="  display-7"><strong>SECTION 18 - GOVERNING LAW</strong></p>
                            <p className="  display-7">These Terms of Service and any separate agreements whereby
                                we provide you Services shall be governed
                                by and construed in accordance with the laws of India and jurisdiction of Jaipur, Rajasthan</p>
                            <p className="  display-7"><strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong>
                            </p>
                            <p className="  display-7">You can review the most current version of the Terms of
                                Service at any time at this page.&nbsp;</p>
                            <p className="  display-7">We reserve the right, at our sole discretion, to update,
                                change or replace any part of these Terms of
                                ...
                                changes.</p>
                            <p className="  display-7"><strong>SECTION 20 - CONTACT INFORMATION&nbsp;</strong>
                            </p>
                            <p className="  display-7">Questions about the Terms of Service should be sent to us
                                at <strong>hi@melo.works</strong>.</p>
                        </div>
                    </div>
                </div>
                {/* <Marquee/> */}
